...
### Fork then clone the `piescope` GitHub repository
If you don't already have a GitHub account, you can create one here:
<https://github.com/join>

**First, fork the `piescope` repository** at
...
```
git clone https://github.com/$YOUR_GITHUB_USERNAME/piescope.git
cd piescope
git remote add upstream https://github.com/DeMarcoLab/piescope.git
```
...
```
You can confirm you are on the correct `develop` branch of the piescope repository by using the command `git branch`.
...
### Install piescope  as an editable installation

Last, pip install `piescope` as an editable installation:
```
conda activate piescope-dev
pip install -e .
```
...
to the upstream repository https://github.com/DeMarcoLab/piescope
...
GitHub pages is enabled un the DeMarcoLab piescope repository settings.
```
